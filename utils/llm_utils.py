...
def load_model(id, model_id='meta-llama/Llama-3.2-3B-Instruct', device=None):
    """
    Loads frozen LLM
    """
    login(id)
    ...
    frozen_model = llm_pipeline.model
    frozen_model.eval()
...
def generate_response(prompt, llm_pipeline, temperature=0.0, top_p=0.9, top_k=50):
    """
